...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "gap-1 rounded-t-xl px-4 group-data-[size=sm]/card:px-3 [.border-b]:pb-4 group-data-[size=sm]/card:[.border-b]:pb-3 group/card-header @container/card-header grid auto-rows-min items-start has-data-[slot=card-action]:grid-cols-[1fr_auto] has-data-[slot=card-description]:grid-rows-[auto_auto] group-data-[variant=autumn]/card:rounded-none group-data-[variant=autumn]/card:pt-0",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-4 group-data-[size=sm]/card:px-3 group-data-[variant=autumn]/card:px-0", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("rounded-b-xl border-t p-4 group-data-[size=sm]/card:p-3 flex items-center group-data-[variant=default]/card:bg-muted/50 group-data-[variant=autumn]/card:rounded-none group-data-[variant=autumn]/card:border-0 group-data-[variant=autumn]/card:pb-6", className)}
      {...props}
    />
  )
}
